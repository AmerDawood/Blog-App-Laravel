      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 ftco-animate">
            ...
            <div class="about-author d-flex p-4 bg-light" style="padding-top: 10%"> 
                <div class="bio mr-5">
                  <img src="{{auth()->user()->hasImage()?auth()->user()->getImageProfile():$user->getImage()}}" alt="Image placeholder" style="border-radius: 50%" class="img-fluid mb-4">
                </div>
                <div class="desc">
                <h3>{{ $user->name }}</h3>
                <p>{{ $profile->about }}</p>
